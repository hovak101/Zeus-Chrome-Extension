...
async function getEbayInfo(name) {
...
async function getAmazonInfo(name) {
  ...
  // Each product is inside a div with this attribute:
...
async function getWalmartInfo(name) {
  ...
  // contains list of items on product search page
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    // return the first non-sponsored link
